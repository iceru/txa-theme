...
<article class="group h-full overflow-hidden rounded-2xl border border-line bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
    <a href="<?php echo esc_url(get_permalink($article)); ?>" class="flex h-full flex-col overflow-hidden text-near-black !no-underline"
    ...
    <div class="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <h3
            class="mt-3 [font-family:'Hanken_Grotesk',sans-serif] text-xl font-semibold leading-7 text-[#151c27] group-hover:text-brand">
        ...
        <div class="mt-auto flex items-center justify-between gap-4 pt-5 text-sm">
            ...
            <span class="font-semibold text-brand" aria-hidden="true">Read more →</span>
        </div>
    </div>
    </a>
</article>
