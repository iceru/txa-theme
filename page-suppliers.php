...
<article class="bg-white text-near-black [font-family:'Source_Sans_Pro',sans-serif]">
    <section class="px-4 pb-8 pt-8 lg:px-5 lg:pb-16">
        <div class="relative mx-auto min-h-[520px] max-w-[1400px] overflow-hidden rounded-2xl bg-near-black lg:min-h-[600px]">
            <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=2200&q=85" alt="Australian coastline" class="absolute inset-0 h-full w-full object-cover">
            ...
            <div class="relative z-10 flex min-h-[520px] items-center px-6 py-16 sm:px-8 lg:min-h-[600px] lg:px-8 lg:py-24">
                <div class="max-w-[760px]">
                    <p class="inline-flex rounded-lg bg-brand px-6 py-3 text-sm font-bold uppercase text-white sm:text-xl">TXA for Australian tourism suppliers</p>
                    <h1 class="mt-4 max-w-[760px] text-4xl font-semibold leading-tight text-white sm:text-5xl lg:text-5xl lg:leading-[56px]">Connect once and sell across more channels</h1>
                    <p class="mt-4 max-w-[660px] text-lg font-semibold leading-[30px] text-white">TXA helps tourism suppliers connect live product, pricing and availability to destination websites, distributors and other online channels without manually allocating to and managing inventory on every site.</p>
    ...
    <section class="bg-surface px-4 py-10 lg:p-16">
        <div class="mx-auto max-w-[1312px] rounded-lg bg-white px-6 py-8 shadow-[0_12px_28px_-8px_rgba(26,26,26,0.12)] lg:px-8 lg:py-[34px]">
            <div class="max-w-[640px]">
                ...
                <p class="mt-2 text-base leading-[30px] text-mid-gray">TXA is designed to reduce manual work by using your booking system as the single source of products, rates and availability where available.</p>
            </div>
    ...
    <section class="px-4 py-12 lg:px-16 lg:py-8">
        <div class="mx-auto max-w-[1312px]">
            ...
            <p class="mt-2 max-w-[723px] text-base leading-6 text-mid-gray">TXA has options for suppliers that don't have a suitable booking system or supported connection pathways</p>
    ...
    <section class="bg-surface px-4 py-12 lg:p-16">
        <div class="mx-auto grid max-w-[1312px] gap-10 rounded-lg bg-white px-6 py-8 shadow-[0_12px_28px_-8px_rgba(26,26,26,0.12)] lg:grid-cols-[565px_1fr] lg:items-center lg:gap-12 lg:px-8 lg:py-[52px]">
            <div>
                ...
                <p class="mt-4 text-base leading-7 text-mid-gray">It's so easy! Use the TXA Get Connected Wizard. It captures your business details, website or social media URL, product description, industry category and images, then lets you confirm whether you want to remain content only or make your connection bookable.</p>
                <div class="mt-4 rounded-lg border border-brand bg-[#ffdad4]/80 p-4 text-base font-semibold leading-5 text-brand">No booking, no fee. Pay only when you receive online bookings through TXA channels, subject to final success fee of 0.75%-2.8% of total booking value.</div>
                <div class="mt-4"><?php echo txa_supplier_button('Apply Now using TXA Get Connected Wizard', $wizard_url, 'primary', true); ?></div>
            </div>
            ...
            <div class="mt-10 space-y-4 lg:px-8">
                <?php foreach ($faqs as $index => $faq): ?>
                    <details class="group rounded-lg border border-line bg-white p-6 shadow-[0_12px_28px_-8px_rgba(26,26,26,0.12)]" <?php echo 0 === $index ? 'open' : ''; ?>>
                        <summary class="cursor-pointer list-none text-xl font-semibold leading-7 text-near-black [&::-webkit-details-marker]:hidden"><span class="flex items-center justify-between gap-6"><?php echo esc_html($faq['question']); ?><span class="text-brand transition group-open:rotate-45" aria-hidden="true">+</span></span></summary>
