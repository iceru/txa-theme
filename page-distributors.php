            ...
            <div
                ...
                <div class="w-full max-w-[760px]">
                    ...
                    <h1
                        ...
                        Unique access to bookable Australian tourism inventory</h1>
                    <p
                        class="mt-4 max-w-[660px] text-base font-medium leading-6 text-white sm:text-lg sm:leading-[30px]">
                        TXA gives distributors a pathway to Australian tourism suppliers across accommodation, tours,
                        attractions, events and experiences. TXA offers distribution channels flexible commercial
                        models, API or white label booking page options, and the ability to participate in
                        destination-led campaigns and trade initiatives.</p>
    ...
    <section class="px-4 py-8 sm:py-10 lg:px-16 lg:py-8">
        <div class="mx-auto max-w-[1312px] rounded-3xl bg-white py-2">
            <div class="max-w-[672px]">
                <h2
                    class="[font-family:'Hanken_Grotesk',sans-serif] text-[28px] font-bold leading-9 tracking-[-0.01em] text-[#151c27] sm:text-3xl">
                    Flexible distribution models</h2>
                <p class="mt-3 text-[15px] leading-6 text-mid-gray sm:mt-4 sm:text-base">We provide multiple ways to
                    consume inventory based on your technical maturity and business model.</p>
            </div>
            ...
            <div
                ...
                <div class="max-w-[687px]">
                    <h2
                        ...
                        Drive regional impact with destination-led campaigns</h2>
                    <p class="mt-4 text-[15px] leading-6 text-white/90 sm:mt-6 sm:text-base">TXA sits at the heart of
                        Australian tourism. We work closely with STOs and RTOs to power booking engines for state-wide
                        initiatives. Become a partner in these high-value trade campaigns.</p>
                    <div class="mt-6">
                        <?php echo txa_distributor_button('Become a TXA distributor', $apply_url, 'light'); ?>
                    </div>
                </div>
            </div>
        </div>
