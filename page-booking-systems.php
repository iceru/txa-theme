        ...
        <div
            ...
            <div
                ...
                <div class="w-full max-w-[760px]">
                    ...
                    <p
                        class="mt-4 max-w-[660px] text-base font-semibold leading-7 text-white sm:text-lg sm:leading-[30px]">
                        TXA helps
                ...
                <div
                    ...
                    <div
                        class="mx-auto mt-7 flex flex-col items-center justify-between gap-4 sm:flex-row sm:gap-2 lg:mt-9">
                        ...
                        <svg class="h-7 w-11 shrink-0 rotate-90 text-white/80 sm:rotate-0" viewBox="0 0 64 24"
                        ...
                        <div class="flex w-full max-w-[130px] flex-col items-center">
                            <span
                                class="flex h-16 w-[104px] items-center justify-center rounded-2xl border border-white/30 bg-white/15 px-3 shadow-lg sm:h-[72px] sm:w-[116px]">
