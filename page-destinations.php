        ...
        <div class="mx-auto max-w-[1312px] text-left sm:text-center">
            ...
            <div class="mt-7 grid gap-4 sm:mt-8 sm:grid-cols-2 sm:gap-6 lg:grid-cols-5">
                <?php foreach ($pillars as $index => $pillar): ?>
                    <article
                        class="flex items-center gap-4 rounded-2xl bg-white p-4 text-left shadow-sm sm:block sm:rounded-3xl sm:text-center">
                        <span
                            class="flex size-12 shrink-0 items-center justify-center rounded-xl bg-[#ffdad4] text-xl text-brand sm:mx-auto sm:size-16 sm:text-2xl">
                            <i class="bi <?php echo esc_attr($pillar['icon']); ?>" aria-hidden="true"></i>
                        </span>
                        <div>
                            <h3
                ...
                <div class="mt-7 grid gap-3 sm:mt-8 sm:gap-4 md:grid-cols-2">
                    <?php foreach ($problems as $problem): ?>
                        <article class="rounded-xl  bg-white px-5 py-5 shadow-sm sm:px-7 sm:py-6">
                            <h3 class="text-base font-semibold text-[#151c27]"><?php echo esc_html($problem['title']); ?>
                            </h3>
                ...
                <div class="mt-5 space-y-5 sm:mt-6 sm:space-y-6">
                    <?php foreach ($solutions as $item): ?>
                        <div class="flex gap-3 sm:gap-4">
                            <span
                                class="mt-1 flex size-7 shrink-0 items-center justify-center rounded-full border border-white/80 text-sm text-white">
